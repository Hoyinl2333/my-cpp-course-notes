...
4. 在派生类访问静态成员
   ...
   即基类所有对象和派生类所有对象都可以访问**同一个**静态成员![image-20240327100644224](../../../../../AppData/Roaming/Typora/typora-user-images/image-20240327100644224.png)对于类的静态成员访问，建议使用 *类名：：成员* 方式访问
